...
public class BooksFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        ArrayList<Book> arrayList = new ArrayList<>(Data.getBooks(section.equals(getString(R.string.scientific)) ? Data.SCIENTIFIC : Data.LITERARY,
        ...
        filter.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            switch (checkedId) {
                case R.id.chip_all:
                    arrayList.addAll(Data.getBooks(Data.ALL));
                    break;
                case R.id.chip_scientific:
                    arrayList.addAll(Data.getBooks(Data.SCIENTIFIC));
                    break;
                case R.id.chip_literary:
                    arrayList.addAll(Data.getBooks(Data.LITERARY));
                    break;
                default:
